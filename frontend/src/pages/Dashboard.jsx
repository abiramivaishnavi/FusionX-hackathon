    ...
    <div className="space-y-10 font-sans pb-10">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-6">
        ...
        <StatCard 
          ...
          icon={AlertTriangle} 
          colorClass="bg-gradient-to-br from-red-600 to-red-900" 
        />
        <StatCard 
          title="Medium Risk" 
          value={stats?.breakdown?.medium || 0} 
          icon={AlertCircle} 
          colorClass="bg-gradient-to-br from-yellow-600 to-amber-800" 
        />
        <StatCard 
          title="Low Severity" 
          value={stats?.breakdown?.low || 0} 
          icon={Activity} 
          colorClass="bg-gradient-to-br from-green-600 to-emerald-900" 
        />
      </div>
      ...
      <div>
        <h2 className="text-3xl font-semibold bg-gradient-to-r from-white to-white/60 bg-clip-text text-transparent flex items-center gap-3 mb-6">
          <Shield className="text-primary" /> Recent Vulnerabilities
        </h2>
